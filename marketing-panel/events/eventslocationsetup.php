...
if (isset($_POST['edit'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $path = "eventslocationsetup.php?edit=$id";
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 ">
                            <form method="POST" action="eventslocationsetup.php" enctype="multipart/form-data">
                                ...
                                <div class="pb-5 pt-3">
                                    ...
                                    <a href="eventslocationsetup.php" class="btn btn-outline-dark ml-3">Close</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="text-decoration:none;"
                                                    href="eventslocationsetup.php?edit=<?php echo $descriptionlist->id ?>"
                                                    class="text-success">
                                                    <i class="nav-icon fas fa fa-edit"></i>
                                                </a> |
                                                <a style="text-decoration:none;"
                                                    href="eventslocationsetup.php?delete=<?php echo $descriptionlist->id ?>"
                                                    class="text-danger">
                                            ...
                                            <td><?php echo $descriptionlist->eventcategoryid ?></td>
