...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $query = "DELETE FROM mktgeventcategory where id='$id'";
    $app = new App;
    $path = "eventcategory.php";
...
if (isset($_POST['submit'])) {
    ...
    $links = $_POST['links'];
    $query = "INSERT INTO mktgeventcategory (location, links)
VALUES(:location, :links)";
    $arr = [
        ":location" => $location,
        ":links" => $links,
    ];
...
if (isset($_POST['update'])) {
    ...
    $location = $_POST['location'];
    $links = $_POST['links'];
    $query = "UPDATE mktgeventcategory SET  location=:location,  links=:links WHERE id='$id'";
    $arr = [
        ":location" => $location,
        ":links" => $links,
    ];

    $path = "eventcategory.php?edit=$id";
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header pt-3">
                    <h1 class="h5 mb-3"><b>Event Location</h1>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- /.Personal Details -->
                        ...
                        <?php if (isset($_GET['edit'])) {
                            ...
                            <div class="col-md-4 mb-3 ">
                                <form method="POST" action="eventcategory.php">
                                    <?php foreach ($category1s as $category1): ?>
                                        <div class="col-md-12 mb-3">

                                            <div class="form-group row">
                                                <label for="colFormLabelSm"
                                                    class="col-sm-3 col-form-label col-form-label-sm">Event Location</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control form-control-sm" id="colFormLabelSm"
                                                        name="location" value="<?php echo $category1->location ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                        ...
                                        <div class="pb-5 pt-3">
                                            ...
                                            <a href="eventcategory.php" class="btn btn-outline-dark ml-3">Close</a>
                                    ...
                                    <tbody>
                                        <?php foreach ($category as $categorylist): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $categorylist->location ?></td>
                                                <td><?php echo $categorylist->links ?></td>
                                                <td>
                                                    <a style="text-decoration:none;"
                                                        href="eventcategory.php?edit=<?php echo $categorylist->id ?>"
                                                        class="text-success">&nbsp;&nbsp;
                                                        <i class="nav-icon fas fa fa-edit"></i>

                                                    </a> |
                                                    <a style="text-decoration:none;"
                                                        href="eventcategory.php?delete=<?php echo $categorylist->id ?>"
                                                        class="text-danger">&nbsp;&nbsp;
