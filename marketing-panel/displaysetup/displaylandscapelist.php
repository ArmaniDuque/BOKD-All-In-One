...
if (isset($_POST['save'])) {
    ...
    $dir = "../../img/mktg/landscape/" . basename($checkofficephoto);
...
if (isset($_POST['edit'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $path = "displaylandscapelist.php?edit=$id";
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 ">
                            <form method="POST" action="displaylandscapelist.php" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <hr>
                                            <div style="">
                                                <img src="<?php echo htmlspecialchars(APPURL); ?>img/mktg/landscape/<?php
                                ...
                                <div class="pb-5 pt-3">
                                    ...
                                    <a href="displaylandscapelist.php" class="btn btn-outline-dark ml-3">Close</a>
                        ...
                        <div class="col-md-8 mb-3 ">
                            ...
                            <div class="col-md-12 ">
                                ...
                                $query = "SELECT * FROM mktgdisplay WHERE slidecategory='1'";
                                $app = new App;
