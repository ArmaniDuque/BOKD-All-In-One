...
if (isset($_POST['save'])) {
    ...
    $dir = "../../img/mktg/portrait/" . basename($checkofficephoto);
...
if (isset($_POST['edit'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $checkofficephoto = $_FILES['checkofficephoto']['name'];
        $dir = "../../img/mktg/portrait/" . basename($checkofficephoto);
        $query = "UPDATE mktgdisplay SET description=:description, title=:title, categoryid=:categoryid, discategoryid=:discategoryid , startdate=:startdate , enddate=:enddate, checkofficephoto=:checkofficephoto, slidecategory=:slidecategory WHERE id=:id";
        $arr = [
            ":title" => $title,
            ":description" => $description,
            ":discategoryid" => $discategoryid,
        ...
        $path = "displayportraitlist.php?edit=$id";
                    ...
                    <div class="row">
                        ...
                        <?php if (isset($_GET['edit'])) {
                            ...
                            <div class="col-md-4 mb-3 ">
                                <form method="POST" action="displayportraitlist.php" enctype="multipart/form-data">
                                    <?php foreach ($description1s as $description1): ?>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <hr>
                                                    <div style="">
                                                        <img src="<?php echo htmlspecialchars(APPURL); ?>img/mktg/portrait/<?php
                                        ...
                                        <div class="pb-5 pt-3">
                                            ...
                                            <a href="displayportraitlist.php" class="btn btn-outline-dark ml-3">Close</a>
                        ...
                        <div class="col-md-8 mb-3 ">
                            ...
                            <div class="col-md-12 ">
                                <h4 class="mb-3 text-primary">List of Slide 1 Landscape Display
                                    --------------------------
                                </h4>

                                <?php
                                $currentdate = date("m-d-Y");
                                $query = "SELECT * FROM mktgdisplay WHERE slidecategory='2'";
                                $app = new App;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="text-decoration:none;"
                                                        href="displayportraitlist.php?edit=<?php echo $descriptionlist->id ?>"
                                                        class="text-success">
                                                        <i class="nav-icon fas fa fa-edit"></i>
                                                    </a> |
                                                    <a style="text-decoration:none;"
                                                        href="displayportraitlist.php?delete=<?php echo $descriptionlist->id ?>"
                                                        class="text-danger">
                                                ...
                                                <td><img src="<?php echo APPURL; ?>img/mktg/portrait/<?php echo $descriptionlist->checkofficephoto ?>"
