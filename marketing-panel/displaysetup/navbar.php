<nav class="navbar navbar-expand-sm bg-body-tertiary bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand text-primary" href="#">Display Setup</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="<?php echo APPURL; ?>marketing-panel/displaysetup/displaycategory.php" class="nav-link">
                        Display Category List
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo APPURL; ?>marketing-panel/displaysetup/category.php" class="nav-link">
                        Category List
                    </a>
                </li>
                <li class="nav-item">
