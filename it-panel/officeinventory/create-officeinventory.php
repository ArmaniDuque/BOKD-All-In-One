...
<?php if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO itpcinventory (userid, pcname, department, ipaddress, subnet, gateway, dns1, dns2, specs, monitor, mouse, ups, printer, other1, other2, other3, username, password, status, remarks)
...
<div class="content-wrapper">
    ...
    <section class="content">
        <!-- Default box -->
        <form class="row g-3" method="POST" action="create-officeinventory.php" enctype="multipart/form-data">
