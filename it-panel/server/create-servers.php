...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO itserver (servername, serverip,  serverstatus, serverlocation, servermac, serverdescription, username, password)
...
<div class="content-wrapper">
    ...
    <section class="content">
        <!-- Default box -->
        <form class="row g-3" method="POST" action="create-servers.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <?php
                                    echo '<select name="serverlocation" id="serverlocation" class="form-control">';
                                    $query = "SELECT *  FROM cctvidf";
                                    $app = new App;
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="serverdescription" id="serverdescription" class="form-control">
                                    </textarea>
