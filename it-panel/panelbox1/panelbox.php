...
<?php
$query = "SELECT * FROM itboxinventory";
$app = new App;
$pcs = $app->selectAll($query);


$query = "SELECT COUNT(*) AS count_gindoors FROM itboxinventory WHERE status='Active'";
$app = new App;
$count_gindoors = $app->selectOne($query);

$query = "SELECT COUNT(*) AS count_dindoors FROM itboxinventory WHERE status='Inactive'";
$app = new App;
...
if (isset($_GET['delete'])) {
    ...
    $query = "DELETE FROM itboxinventory WHERE boxid='$id'";
    $app = new App;
    $path = "panelbox.php";
                                ...
                                <td><?php echo $pc->other3 ?></td> -->
                                    ...
                                    <td>
                                        <a style="text-decoration:none;"
                                            href="update-panelbox.php?edit=<?php echo $pc->boxid ?>"
                                            class="text-success">&nbsp;&nbsp;
                                            <i class="nav-icon fas fa fa-edit"></i>&nbsp;&nbsp;

                                        </a>|
                                        <a style="text-decoration:none;" href="panelbox.php?delete=<?php echo $pc->boxid ?>"
                                            class="text-danger">&nbsp;&nbsp;
