...
if (isset($_POST['submit'])) {
    ...
    $wifimodel = $_POST['wifimodel'];
    $wifiip = $_POST['wifiip'];
    $wifiname = $_POST['wifiname'];
    $wifimac = $_POST['wifimac'];
    $wifisn = $_POST['wifisn'];
    $wifitype = $_POST['wifitype'];
    $wifistatus = $_POST['wifistatus'];
    $wifiusername = $_POST['wifiusername'];
    $wifipassword = $_POST['wifipassword'];
    $wifiremarks = $_POST['wifiremarks'];

    // `wifiid`, `wifimodel`, `wifiip`, `wifiname`, `wifimac`, `wifisn`, `wifitype`, `wifistatus`, `wifiusername`, `wifipassword`, `wifiremarks`
    $query = "INSERT INTO itinternetwif (wifimodel, wifiip, wifiname, wifimac, wifisn, wifitype, wifistatus, wifiusername, wifipassword, wifiremarks)
VALUES(:wifimodel, :wifiip, :wifiname, :wifimac, :wifisn, :wifitype, :wifistatus, :wifiusername, :wifipassword, :wifiremarks)";
    $arr = [
        ":wifimodel" => $wifimodel,
        ":wifiip" => $wifiip,
        ":wifiname" => $wifiname,
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header pt-3">
                    <h1 class="h5 mb-3"><b>Add</h1>

                </div><br>
                <form class="row g-3" method="POST" action="create-panelbox.php">
                    <!-- /.BODY -->
                    <div class="card-body">
                        <div class="row">
