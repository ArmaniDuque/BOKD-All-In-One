...
if (isset($_POST['submit'])) {
    ...
    $path = "update-tv.php?edit=$AssetID";
...
if (isset($_POST['update'])) {
    ...
    $query = " UPDATE ittv SET 
    DeviceType = :DeviceType, 
    MakeModel = :MakeModel, 
    MakeModel1 = :MakeModel1, 
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <?php foreach ($tvs as $tv): ?>
                    <form class="row g-3" method="POST" action="update-tv.php" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="AssetID" id="AssetID" class="form-control"
                                            value="<?php echo $tv->AssetID ?>" placeholder=" Camera Name">
                                        <select name="DeviceType" id="DeviceType" class="form-control">
                                            <option value="<?php echo $tv->DeviceType ?>">
                                                <?php echo $tv->DeviceType ?>
                                            </option>
                                ...
                                <div class=" col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <select name="Department" id="Department" class="form-control">
                                            <option value="<?php echo $tv->Department ?>">
                                                <?php echo $tv->Department ?>
                                            </option>
                            ...
                            <div class=" row">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="PhysicalLocation" id="PhysicalLocation"
                                            class="form-control" value="<?php echo $tv->PhysicalLocation ?>" placeholder="">
                                    </div>
                                </div>
                                <div class=" col-md-2">
                                    <div class="mb-3">
                                        <label for="email">TV Make/Model</label>
                                        <input type="text" name="MakeModel" id="MakeModel" class="form-control"
                                            value="<?php echo $tv->MakeModel1 ?>" placeholder=" ">
                                    </div>
                                </div>
                                <div class=" col-md-2">
                                    <div class="mb-3">
                                        <label for="email">Living Area </label>
                                        <select name="DayBed" id="DayBed" class="form-control">
                                            <option value="<?php echo $tv->DayBed ?>">
                                                <?php echo $tv->DayBed ?>
                                            </option>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        <label for="email">TV Make/Model</label>
                                        <input type="text" name="MakeModel1" id="MakeModel1" class="form-control"
                                            value="<?php echo $tv->MakeModel ?>" placeholder=" ">
                                    </div>
                                </div>
                                <div class=" col-md-2">
                                    <div class="mb-3">
                                        <label for="email">Bed Room </label>
                                        <select name="Bedside" id="Bedside" class="form-control">
                                            <option value="<?php echo $tv->Bedside ?>">
                                                <?php echo $tv->Bedside ?>
                                            </option>
                                            <option value="">NO-SETUP
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="Remarks" id="Remarks"
                                            class="form-control"><?php echo $tv->Remarks ?> </textarea>
                                        <?php echo $tv->Remarks ?>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="Notes" id="Notes"
                                            class="form-control"><?php echo $tv->Notes ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <select name="OperationalStatus" id="OperationalStatus" class="form-control">
                                            <option value="<?php echo $tv->OperationalStatus ?>">
                                                <?php echo $tv->OperationalStatus ?>
                                            </option>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <select name="ConnectionStatus" id="ConnectionStatus" class="form-control">
                                            <option value="<?php echo $tv->ConnectionStatus ?>">
                                                <?php echo $tv->ConnectionStatus ?>
                                            </option>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="PurchaseDate" id="PurchaseDate" class="form-control"
                                            value="<?php echo $tv->PurchaseDate ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="PurchasePrice" id="PurchasePrice" class="form-control"
                                            value="<?php echo $tv->PurchasePrice ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="WarrantyContract" id="WarrantyContract"
                                            class="form-control" value="<?php echo $tv->WarrantyContract ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="MaintenanceLog" id="MaintenanceLog" class="form-control"
                                            value="<?php echo $tv->MaintenanceLog ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="SerialNumber" id="SerialNumber" class="form-control"
                                            value="<?php echo $tv->SerialNumber ?>" placeholder="">
                                    </div>
                                </div>
                                <div class=" col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="MACAddress" id="MACAddress" class="form-control"
                                            value="<?php echo $tv->MACAddress ?>" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="LastAuditDate" id="LastAuditDate" class="form-control"
                                            value="<?php echo $tv->LastAuditDate ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="LastActivity" id="LastActivity" class="form-control"
                                            value="<?php echo $tv->LastActivity ?>">
