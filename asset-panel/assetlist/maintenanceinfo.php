                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3 ">
                                    ...
                                    <div class="col-md-12 ">
                                        <h4 class="mb-3 text-primary">Asset Maintenance History Information
                                                ...
                                                $('#history').DataTable({
                                                    ...
                                                    columns: [{
                                                        ...
                                                        render: function (data, type, row) {
                                                            ...
                                                            // return '<a style="text-decoration:none;" href="update-assetlist.php?select=' +
                                                            //     row.id +
                                                            //     '" class="text-success">&nbsp;&nbsp;<i class="nav-icon fas fa-caret-square-right"> Update</i></a>';

                                                            return '<a style="text-decoration:none;" href="update-assetlist.php?select=' +
                                                                row.id +
                                                                '"  class="text-success">&nbsp;<i class="nav-icon fas fa fa-edit"></i></a> | <a style="text-decoration:none;" href="index.php?delete=' +
                                                                row.id +
