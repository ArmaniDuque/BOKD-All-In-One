...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $query = "DELETE FROM poscategory where id='$id'";
    $app = new App;
    $path = "category.php";
...
if (isset($_POST['submit'])) {
    ...
    $icon = $_POST['icon'];
    $others = $_POST['others'];
    $query = "INSERT INTO poscategory (category, sequence, icon, color, others)
...
if (isset($_POST['update'])) {
    ...
    $icon = $_POST['icon'];
    $others = $_POST['others'];
    $query = "UPDATE poscategory SET category=:category, color=:color, sequence=:sequence, icon=:icon, others=:others WHERE id='$id'";
    $arr = [
        ":color" => $color,
        ":category" => $category,
        ":sequence" => $sequence,
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header pt-3">
                    <h1 class="h5 mb-3"><b>Main Category</h1>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- /.Personal Details -->
                        ...
                        <div class="col-md-4 mb-3 ">
                            <form method="POST" action="category.php">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-group row">
                                        <label for="colFormLabelSm"
                                            class="col-sm-3 col-form-label col-form-label-sm">Main Category</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <?php
                                            $query = "SELECT * FROM poscategory WHERE id='$category1->id'";
                                            $app = new App;
                        ...
                        <div class="col-md-8 mb-3 ">
                            ...
                            <div class="col-md-12 ">
                                <h4 class="mb-3 text-primary">List of Main Category --------------------------
                                </h4>
                                <?php
