...
switch ($method) {
    case 'GET':
        switch ($endpoint) {
            ...
            case 'order':
                // For simplicity, we'll fetch the most recent 'Pending' order for a dummy customer.
                // In a real app, you'd manage sessions or cashier IDs.
                $customer_id = $_GET['customerid'] ?? 'Walk-in'; // Example customer ID
            ...
            case 'orderitems':
                ...
                // Note: The `posorderitems` table name seems to have a typo (`orde` instead of `order`).
                // Ensure your database table name matches exactly. I'm using `posorderitems` as provided.
