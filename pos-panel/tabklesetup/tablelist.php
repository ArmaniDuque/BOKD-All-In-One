...
<div class="content-wrapper">
                        ...
                        <div class="col-md-4 mb-3 ">
                            <form method="POST" action="menulist.php">
                                ...
                                LEFT JOIN poscategory ON posmenu.categoryid = poscategory.id WHERE menuid='$id'";
                                    ...
                                    <div class=" flex flex-col md:flex-row items-left md:items-start p-2 m-2 rounded-xl shadow-md relative
    <?php echo (isset($menu1->status) && $menu1->status == 0) ? 'bg-gray-200' : 'bg-green-50'; ?>">
                                        ...
                                        <img src="https://placehold.co/100x100/A3BBAD/ffffff?text=<?php echo $menu->name ?>"
                                            alt="<?php echo $menu->name ?>" class="w-24 h-24 rounded-lg mr-6 mb-4 md:mb-0 object-cover
        <?php echo (isset($menu1->status) && $menu1->status == 0) ? 'grayscale' : ''; ?>">

                                        <!-- Menu Item Details -->
                                        <div class="flex-grow text-center md:text-left">
                                            <h2 class="text-2xl font-semibold mb-2
            <?php echo (isset($menu1->status) && $menu1->status == 0) ? 'text-gray-600' : 'text-green-700'; ?>">
                                                <?php echo $menu->name ?>
                                            </h2>
                                            <p class="mb-3
            <?php echo (isset($menu1->status) && $menu1->status == 0) ? 'text-gray-500' : 'text-gray-700'; ?>">
                                                <?php echo $menu->description ?>
                                            </p>
                                            <span
                                                class="text-xl font-bold
            <?php echo (isset($menu1->status) && $menu1->status == 0) ? 'text-gray-600 line-through' : 'text-green-800'; ?>">
                                                <?php echo $menu->price ?>
                                            </span>
                                        </div>
