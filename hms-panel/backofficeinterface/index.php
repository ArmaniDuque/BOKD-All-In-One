...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Back Office Interface Module</h1>
                </div>
                            ...
                            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="custom-content-below-1-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Revenu Transfer</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-2-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Market Statistic Transfer</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-3-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Daily Statistic</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " id="custom-content-below-4-tab" data-toggle="pill"
                                        ...
                                        aria-selected="true">City Ledger</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-5-tab" data-toggle="pill"
                                        ...
                                        aria-selected="true">Misceleneous Export</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-6-tab" data-toggle="pill"
                                        ...
                                        aria-selected="true">Transfer Status</a>
                                </li>
