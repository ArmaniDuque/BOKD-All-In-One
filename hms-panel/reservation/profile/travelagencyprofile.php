        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header pt-3">
                    <h1 class="h5 mb-3"><b>Travel Agency Profile</h1>
                                    ...
                                    <table class="table table-striped " style="width:100%" id="history">
                                        ...
                                        <tbody>
                                            <?php foreach ($companyinfos as $companyinfo): ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $companyinfo->companyid ?></td>

                                                    <td><?php echo $companyinfo->companyname ?></td>
                                                    <td><?php echo $companyinfo->address ?></td>
                                                    <td><?php echo $companyinfo->source ?></td>
                                                    <td><?php echo $companyinfo->contactperson ?></td>


                                                    <td>
                                                        <?php
                                                        echo $companyinfo->contactnumber1;
                                                        echo " : ";
                                                        echo $companyinfo->contactnumber1;
                                                        ?>
                                                    </td>
