                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control form-control-sm" placeholder=""
                                                name="checkoutdate" id="checkoutdate" onchange="countdays()"
                                                onclick="noOfDays" value="<?php echo $checkoutdate ?>">
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            function countdays() {
                                ...
                                document.getElementById("demo1").innerHTML = formatDate(datestart);
                                document.getElementById("demo2").innerHTML = formatDate(dateend);

                                document.getElementById("day1").value = formatDate(datestart);
                                document.getElementById("day2").value = formatDate(dateend);
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <form name="x" action="" method="GET">
                                            ...
                                            <input type="text" name="day1" id="day1" value='<?php if (isset($_GET['day1'])) {
                                                        echo $days = $_GET['day1'];
                                                    } ?>'>
                                            <input type="text" name="day2" id="day2" value='<?php if (isset($_GET['day2'])) {
                                                        echo $days = $_GET['day2'];
                                                    } ?>'>
