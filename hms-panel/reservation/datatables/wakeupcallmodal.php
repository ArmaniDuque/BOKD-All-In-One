...
<?php if (isset($reservationid)) {
    $reswakeuphistory = $app->selectone("SELECT count(reservationid) as reservationwakeup FROM reswakeup WHERE reservationid='$reservationid' ");
                ...
                <div class="modal-body">
                    <div class="col-md-12 ">
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                <?php
                                $reswakeuphistory = $app->selectone("SELECT SUM(reservationid) as reservationwakeup FROM reswakeup WHERE reservationid='$reservationid' ");
                                $reswakeuphistory->reservationwakeup;

                                if ($reswakeuphistory->reservationwakeup > 0) {
                                    $query = "SELECT * FROM reswakeup where reservationid=$reservationid ";
                                    $app = new App;
