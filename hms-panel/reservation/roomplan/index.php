                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php
                                    ...
                                    // Display the full guest name if available, otherwise the first letter of the status
                                    $displayContent = $cellData['guestName'] ? htmlspecialchars($cellData['guestName']) : substr($cellData['status'], 0, 1);
                        ...
                        <td style="background-color: <?php echo getStatusColor($cellData['status']); ?>; border: 1px solid #e5e7eb; border-radius: 0.125rem;"
                            ...
                            <?php echo $displayContent; // Output the full guest name or status initial ?>
                        </td>
                        <?php endforeach; ?>
                    </tr>
                    <?php endforeach; ?>
