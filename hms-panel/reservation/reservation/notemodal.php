...
<?php if (isset($reservationid)) {
    $resnotehistory = $app->selectone("SELECT count(reservationid) as reservationnote FROM hmsresnote WHERE reservationid='$reservationid' ");
                ...
                <div class="modal-body">
                    <div class="col-md-12 ">
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                <?php
                                $resnotehistory = $app->selectone("SELECT SUM(reservationid) as reservationnote FROM hmsresnote WHERE reservationid='$reservationid' ");
                                $resnotehistory->reservationnote;

                                if ($resnotehistory->reservationnote > 0) {
                                    $query = "SELECT * FROM hmsresnote where reservationid=$reservationid ";
                                    $app = new App;
                                    ...
                                    <?php foreach ($notes as $note): ?>
                                        <tr>
                                            <td>
                                                <?php $query = "SELECT * FROM hmsnote where id='$note->noteid'";
                                                $app = new App;
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control form-control-sm" id="noteid" name="noteid">
                                        ...
                                        <?php
                                        $query = "SELECT * FROM hmsnote  where id='$noteid'";
                                        $app = new App;
                                        $note1s = $app->selectAll($query);
                                        ?>
                                        <?php foreach ($note1s as $note1): ?>
