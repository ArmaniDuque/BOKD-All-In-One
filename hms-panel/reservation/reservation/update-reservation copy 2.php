                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3 ">
                            <div class="side-buttons">
                                ...
                                <button class="btn btn-block btn-primary btn-sm" id="splitBtn" disabled>Split</button>
                        ...
                        <div class=" col-md-10 mb-3 ">
                            ...
                            $today = date("Y-m-d");; // This can be changed to date('Y-m-d') for dynamic current date
                                ...
                                <table id="hmsReservationsTable" class="display min-w-full bg-white">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td><?php echo htmlspecialchars($row['reservationtype'] ?? 'N/A'); ?></td>
