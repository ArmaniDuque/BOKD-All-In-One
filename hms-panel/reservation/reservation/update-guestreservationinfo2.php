                            ...
                            <div class="card">
                                <div class="m-2 flex text-center">
                                    ...
                                    <?php } elseif ($selectedreservation->status == "Checkin") { ?>
                                        ...
                                        <button class="btn btn-primary" type="submit" name="checkout" <?php
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 ">
                                            <h4 class="mb-3 text-primary">Personal Information
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <input type="date" class="form-control form-control-sm" id="checkindate"
                                                            name="checkindate" <?php echo ($selectedreservation->status == "Checkin") ? "readonly" : ""; ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="form-control form-control-sm" id="checkoutdate"
                                                            name="checkoutdate" <?php echo ($selectedreservation->status == "Checkin") ? "readonly" : ""; ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input class="form-control form-control-sm" type="number" id="noofnights"
                                                            name="noofnights" <?php echo ($selectedreservation->status == "Checkin") ? "readonly" : ""; ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control form-control-sm" id="dratecodeid"
                                                            ...
                                                            value=" <?php $query = "SELECT * FROM hmsratecode where id=$selectedreservation->ratecodeid";
                                                            $app = new App;
                                                        ...
                                                        <select class=" custom-select form-control-sm" id="ratecodeid"
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM hmsratecode where id=$selectedreservation->ratecodeid";
                                                            $app = new App;
                                                            $ratecodes = $app->selectAll($query);
                                                            ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="droomtypeid"
                                                            ...
                                                            value=" <?php $query = "SELECT * FROM hmsroomtypes where id=$selectedreservation->roomtypeid";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <select class="custom-select form-control-sm" name="blockecodeid"
                                                            id="blockecodeid">
                                                            <?php
                                                            $query = "SELECT * FROM hmsblocked where id=$selectedreservation->blockecodeid";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="custom-select form-control-sm" name="currencyid"
                                                            id="currencyid">
                                                            <?php
                                                            $query = "SELECT * FROM hmscurrency where id=$selectedreservation->currencyid";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select class="custom-select form-control-sm" name="reservationtype"
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM hmsreservationtype where id=$selectedreservation->reservationtype";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select class="custom-select form-control-sm" name="marketid" id="marketid">
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM hmsmarket where id=$selectedreservation->marketid";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select class="custom-select form-control-sm" name="agentid" id="agentid">
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM hmsagent where id=$selectedreservation->agentid";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select class="custom-select form-control-sm" name="originid" id="originid">
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM hmsorigin where id=$selectedreservation->originid";
                                                            $app = new App;
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select class="custom-select form-control-sm" name="sourceid" id="sourceid">
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM hmssource where id=$selectedreservation->sourceid";
                                                            $app = new App;
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <h6 class="text-uppercase text-body-secondary mb-2">
                                                                        Running Balance : <span class="h5 mb-0">
                                                                            <?php $pdo = new PDO("mysql:host=localhost;dbname=allinonedb", "root", "");
                                                                            $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                                                            $stmt = $pdo->prepare("SELECT SUM(gf.qty * gf.amount) AS balance FROM hmsguestfolio gf WHERE gf.reservationid = :reservationid");
                                                                            $stmt->bindParam(':reservationid', $reservationid);
                                                                            $stmt->execute();
