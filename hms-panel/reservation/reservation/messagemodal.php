...
<?php if (isset($reservationid)) {
    $resmessagehistory = $app->selectone("SELECT count(reservationid) as reservationmessage FROM hmsresmessage WHERE reservationid='$reservationid' ");
                ...
                <div class="modal-body">
                    <div class="col-md-12 ">
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                <?php
                                $resmessagehistory = $app->selectone("SELECT SUM(reservationid) as reservationmessage FROM hmsresmessage WHERE reservationid='$reservationid' ");
                                $resmessagehistory->reservationmessage;

                                if ($resmessagehistory->reservationmessage > 0) {
                                    $query = "SELECT * FROM hmsresmessage where reservationid=$reservationid ";
                                    $app = new App;
                                    ...
                                    <?php foreach ($messages as $message): ?>
                                        <tr>
                                            <td>
                                                <?php $query = "SELECT * FROM hmsmessages where id='$message->messageid'";
                                                $app = new App;
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control form-control-sm" id="messageid" name="messageid">
                                        ...
                                        <?php
                                        $query = "SELECT * FROM hmsmessages where id='$messageid'";
                                        $app = new App;
                                        $message1s = $app->selectAll($query);
                                        ?>
                                        <?php foreach ($message1s as $message1): ?>
