                        ...
                        <div class="card-body">
                            <table class="table table-striped table-head-fixed text-nowrap" id="history1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center">No transactions for Win 1</td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-head-fixed text-nowrap" id="history2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center">No transactions for Win 2</td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-head-fixed text-nowrap" id="history3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center">No transactions for Win 3</td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
