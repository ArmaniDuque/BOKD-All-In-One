...
<div class="content-wrapper">
    ...
    <section class="content">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group row">
                                    <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">Middle
                                        Name / Title</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" placeholder="Middle
                                        Name">
                                    </div>
                                    <div class="col-sm-3">
        ...
        <div class="pb-5 pt-3">
            ...
            <a href="userslist.php" class="btn btn-outline-dark ml-3">Check In</a>
            <a href="userslist.php" class="btn btn-outline-dark ml-3">Option</a>
            <a href="userslist.php" class="btn btn-outline-dark ml-3">Cancel Transaction</a>
        </div>
        <!-- /.card -->
    </section>
    <!-- /.content -->
