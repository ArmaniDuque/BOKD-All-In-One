                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm"> First
                                                Name. : <?php echo $selctedname->firstname; ?></label>
                                            ...
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm"> Home
                                                Address : <?php echo $selctedname->middlename; ?></label>
                                            ...
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm">Billing
                                                Instruction: <?php echo $selctedname->middlename; ?></label>
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm"> Contact
                                                Number : <?php echo $selctedname->middlename; ?></label>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm">No of
                                                Nights: <?php echo $selctedname->middlename; ?></label>
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm"> Rate :
                                                <?php echo $selctedname->middlename; ?></label>
                                            <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm"> No of
                                                Person : Adult : <?php echo $selctedname->middlename; ?> Kids :</label>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            if ($accompanyhistory->reservationaccompany > 0) {
                                                ...
                                                foreach ($accompanys as $accompany) {
                                                    $query = "SELECT * FROM hmst_customerinfo where customerid=$accompany->customerid";
                                                    $app = new App;
                                                    $accompanynames = $app->selectAll($query);

                                                    foreach ($accompanynames as $accompanyname) {
                                                        $fullName = $accompanyname->firstname . ' ' . $accompanyname->lastname;
                                                        ...
                                                        if ($age <= 12) {
                                                            $kids[] = $fullName . ' Age : ' . $age;
                                                        } elseif ($age <= 59) {
                                                            $adults[] = $fullName . ' Age : ' . $age;
                                                        } else {
                                                            $seniors[] = $fullName . ' Age : ' . $age;
                                                        }
                                                    }
                                                }
                                                ?>
                                                ...
                                                <label for="colFormLabelSm" class="col-sm-12 col-form-label col-form-label-sm">Seniors:
                                                    <?php if (!empty($seniors)) {
                                                        echo implode(', ', $seniors);
                                                    } else {
                                                        echo "None";
                                                    } ?>
                                                </label>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <p>The undersigned recognizes that the use of the facilities at MBCI naturally involves
                                                risks of injury and/or damage, whether caused by the undersigned or someone else. As
                                                such, the undersigned agrees that he or she understands and voluntarily accepts such
                                                risks, which may include any injury, including, without limitation, personal,
                                                bodily, or mental injury, economic loss, or any damage (hereinafter collectively
                                                "damages") to the undersigned, the undersigned's spouse, the undersigned's children,
                                                guests, or relatives (hereinafter collectively "guests"), resulting from any cause,
                                                whether due to Montemar's actions or not.</p>

                                        </div>
                                        <div class="col-sm-12">

                                            <p>Thus, the guest agrees to release Montemar Beach Club and any of its affiliated
                                                entities or officers, directors, members, agents, servants, or employees
                                                (hereinafter collectively "Montemar") from all liability. The guest further agrees
                                                to discharge and commits not to take any legal action against Montemar for any and
                                                all damage that the guest may incur during his/her stay at Montemar, which includes,
                                                without limitation, occasions for the use of the Club's facilities and participation
                                                in any of the activities sponsored by Montemar, whether conducted in or outside of
                                                any premises owned or operated by Montemar. This waiver releases Montemar from any
                                                liability to the guest.</p>
