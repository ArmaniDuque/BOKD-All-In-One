                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-head-fixed text-nowrap" id="history1">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $pdo->prepare("SELECT gf.id AS guestfolio_id, gf.date, t.code, t.description, gf.qty, gf.amount FROM hmsguestfolio gf JOIN hmstransactions t ON gf.transactionid = t.id WHERE gf.reservationid = :reservationid AND gf.win = 1 ORDER BY gf.date ASC");
                                            $stmt->bindParam(':reservationid', $reservationid);
                                            $stmt->execute();
                                            ...
                                            if ($pays1) {
                                                foreach ($pays1 as $pay): ?>
                                                    <tr data-id="<?php echo $pay->guestfolio_id; ?>">
                                                        ...
                                                        <td><?php echo number_format((float) ($pay->qty * $pay->amount), 2); ?></td>
                                                        <td>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-head-fixed text-nowrap" id="history2">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $pdo->prepare("SELECT gf.id AS guestfolio_id, gf.date, t.code, t.description, gf.qty, gf.amount FROM hmsguestfolio gf JOIN hmstransactions t ON gf.transactionid = t.id WHERE gf.reservationid = :reservationid AND gf.win = 2 ORDER BY gf.date ASC ");
                                            $stmt->bindParam(':reservationid', $reservationid);
                                            $stmt->execute();
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-head-fixed text-nowrap" id="history3">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $pdo->prepare("SELECT gf.id AS guestfolio_id, gf.date, t.code, t.description, gf.qty, gf.amount FROM hmsguestfolio gf JOIN hmstransactions t ON gf.transactionid = t.id WHERE gf.reservationid = :reservationid AND gf.win = 3 ORDER BY gf.date ASC ");
                                            $stmt->bindParam(':reservationid', $reservationid);
                                            $stmt->execute();
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-head-fixed text-nowrap" id="history4">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt = $pdo->prepare("SELECT gf.id AS guestfolio_id, gf.date, t.code, t.description, gf.qty, gf.amount FROM hmsguestfolio gf JOIN hmstransactions t ON gf.transactionid = t.id WHERE gf.reservationid = :reservationid AND gf.win = 4 ORDER BY gf.date ASC ");
                                            $stmt->bindParam(':reservationid', $reservationid);
                                            $stmt->execute();
                                            ...
                                            if ($pays4) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <!-- <td colspan="3" class="text-center">No transactions for Win 4</td> -->
                                                </tr>
                                            <?php } ?>
                                            <?php $pdo = null; ?>
                                        </tbody>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                function getNewWin(targetElement) {
                    ...
                    const newWin = parseInt(cardTitle.split(':')[1].trim());
                    document.getElementById('target_win').value = newWin; // Set the target_win value
                    return newWin;
                }
