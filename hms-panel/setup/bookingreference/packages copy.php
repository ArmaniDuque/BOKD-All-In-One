                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3 ">
                            ...
                            <div class="col-md-12 ">
                                <h4 class="mb-3 text-primary">List of hmspackages --------------------------
                                </h4>
                                ...
                                <table class="table table-striped " style="width:100%" id="history">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $packages->packages ?></td>
                                            <td><?php echo $packages->description ?></td>
                                            <td><?php echo $packages->price ?>
                                            </td>
                                            <td><?php echo $packages->categoryid ?>
                                            </td>
                                            <td><?php echo $packages->calculaterateby ?>
                                            </td>
                                            <td>
                                                <a style="text-decoration:none;"
                                                    href="packages.php?edit=<?php echo $packages->id ?>"
                                                    class="text-success">&nbsp;&nbsp;
                                                    <i class="nav-icon fas fa fa-edit"></i>

                                                </a> |
                                                <a style="text-decoration:none;"
                                                    href="packages.php?delete=<?php echo $packages->id ?>"
                                                    class="text-danger">&nbsp;&nbsp;
