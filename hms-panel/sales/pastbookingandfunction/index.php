        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header pt-3">
                    <h1 class="h5 mb-3"><b>Past/Present Booking and Function</h1>
                </div>
                as
                <!-- <div class="col-md-12">
                    <div class="card">
                            ...
                            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-2-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Queue Reservation</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-3-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Inhouse Guest</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-5-tab" data-toggle="pill"
                                        ...
                                        aria-selected="true">Room Assisgnment</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-content-below-8-tab" data-toggle="pill"
                                        ...
                                        aria-selected="true">Wake-up Calls</a>
                                </li>
                                <li class="nav-item">
