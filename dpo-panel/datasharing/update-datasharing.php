...
if (isset($_GET['edit'])) {
    ...
    $query = "SELECT * FROM dposharing where sharingid='$id'";
    $app = new App;
...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE dposharing SET userid=:userid, datetoday=:datetoday, datacollected=:datacollected, purpose=:purpose, otherpurpose=:otherpurpose, dateuse=:dateuse, dateto=:dateto, requesteddep=:requesteddep, depuserid=:depuserid where sharingid='$id'";
    $arr = [
        ":userid" => $userid,
        ":datetoday" => $datetoday,
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <form class="row g-3" method="POST" action="update-datasharing.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" readonly name="datetoday" id="datetoday"
                                            value="<?php echo $sharing->datetoday ?>" class="form-control">
                                        <input type="hidden" name="id" id="id" value="<?php echo $sharing->sharingid ?>"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="datacollected"
                                            value="<?php echo $sharing->datacollected ?>" id="datacollected"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="purpose" value="<?php echo $sharing->purpose ?>"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="otherpurpose" name="otherpurpose"
                                                rows="3"><?php echo $sharing->otherpurpose ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="dateuse" id="dateuse"
                                            value="<?php echo $sharing->dateuse ?>" class="form-control">
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="dateto" id="dateto" value="<?php echo $sharing->dateto ?>"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    placeholder="Slug"> -->
                                        ...
                                        if ($_SESSION['userrole'] == "admin") {
                                            ...
                                            foreach ($departments as $department) {
                                                ...
                                                echo '<input type="hidden" value=' . $department->userid . ' name="requesteddep" class="form-control">';
                                                echo '<input type="text" disabled class="form-control" value="' . $department->userfullname . ' : ' . $department->userposition . '">';
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-6">
                                        ...
                                        if ($_SESSION['userrole'] == "admin") {
                                            ...
                                            $query = "SELECT * FROM dpodepartmenthead WHERE userid='$sharing->depuserid' ";
                                            $app = new App;
                                            $departments = $app->selectAll($query);
                                            foreach ($departments as $department) {
                                                // echo $department->userid;
                                    
                                                $query = "SELECT * FROM dpousermasterfile WHERE userid='$sharing->depuserid' ";
                                                $app = new App;
                            ...
                            <div class="pb-5 pt-3">
                                ...
                                if ($_SESSION['userrole'] == "admin") {
                                    ...
                                    if ($sharing->statusdpo == "Approved") {
                                        echo '<a class="btn btn-success" >Approved by DPO</a>';
                                        echo '  ';

                                    } else {
                                        echo '<a class="btn btn-primary " href="approveddpo.php?id=' . $sharing->sharingid . '">Approve DPO</a>';
                                        echo '  ';

                                    }

                                    if ($sharing->statusgm == "Approved") {
                                        echo '<a class="btn btn-success" >Approved by GM</a>';
                                        echo '  ';

                                    } else {
                                        echo '<a class="btn btn-primary " href="approvedgm.php?id=' . $sharing->sharingid . '">Approve GM</a>';
                                        echo '  ';
                                    }
                                }
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="datasharing.php" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
            </form>
