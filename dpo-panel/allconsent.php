        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid my-2">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Montemar Beach Club Consent Form</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <object data="../pdffiles/MBCI llConsentForm.pdf" type="application/pdf" width="100%"
                                    height="1000px">
                                    <p>Unable to display PDF file. <a
                                            href="../pdffiles/MBCI llConsentForm.pdf">Download</a>
                                        instead.</p>
                                </object>
