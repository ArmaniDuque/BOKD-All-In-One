...
<div class="content-wrapper">
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="departmentrequest.php" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <form class="row g-3" method="POST" action="create-departmentrequest.php" enctype="multipart/form-data">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    //         $query = "SELECT DISTINCT dpodepartmenthead FROM dpousermasterfile";
                                    //         $app = new App;
                            ...
                            <div class="col-md-8">
                                <div class="col-md-6">
                                    <label for="email">Department Involve:</label>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="departmentrequest.php" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </div>
            <!-- /.card -->
        </section>
