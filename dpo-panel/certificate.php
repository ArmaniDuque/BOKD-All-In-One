        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid my-2">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Montemar Beach Club Data Privacy Certificate and Seal</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <object data="../pdffiles/SealandCertificate.pdf" type="application/pdf" width="100%"
                                    height="1000px">
                                    <p>Unable to display PDF file. <a
                                            href="../pdffiles/SealandCertificate.pdf">Download</a>
                                        instead.</p>
                                </object>
